...
namespace Mug.Compilation
{
    public class CompilationUnit
    {
        ...
        public void Compile(int optimizazioneLevel, string output, bool deleteBitcode, string optionalFlag)
        {
            // generates the bytecode
            Generate();

            CompileModule(optimizazioneLevel, output, deleteBitcode, optionalFlag);
        }

        /// <summary>
        /// writes the llvm module to a file and calls the llvm compiler on it
        /// </summary>
        private void CompileModule(int optimizazioneLevel, string output, bool deleteBitcode, string optionalFlag)
        {
            writeFile(
                IRGenerator.Module,
                optimizazioneLevel,
            ...
            static void writeFile(LLVMModuleRef module, int optimizazioneLevel, string bitcode, string output, bool deleteBitcode, string optionalFlag)
            {
                ...
                if (deleteBitcode && File.Exists(bitcode)) File.Delete(bitcode);
            }
