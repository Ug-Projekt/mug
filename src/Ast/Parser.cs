...
abstract class Parser
{
    ...
    virtual public TokenCollection _syntaxTree { get; set; }
    ...
    abstract public Ast GetAbstractSyntaxTree(TokenCollection synT);
    ...
    virtual public bool MatchTokens(TokenKind[] pattTokSeries, int tokenIndex = -1)
    {
        if (tokenIndex == -1)
